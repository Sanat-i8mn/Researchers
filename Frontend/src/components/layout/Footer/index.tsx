      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-16 pb-12 border-b border-white/10">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-white to-cyan-400 bg-clip-text text-transparent">ResearchHub</span>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: 'Find Project', path: '/bidding' }
              ].map((item) => (
                <li key={item.label}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><button onClick={() => handleNavigation('/signup')} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Get Verified</button></li>
              <li><button onClick={() => handleNavigation('/signup')} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Certification</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Help Center', 'Contact Support', 'Trust & Safety', 'Commission Policy'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">{item}</a>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-12 border-y border-white/10">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:support@researchhub.com" className="text-sm text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[
                { icon: FileText, color: 'hover:bg-gray-500/20', iconColor: 'hover:text-gray-300', href: '/blog' },
                { icon: Twitter, color: 'hover:bg-blue-400/20', iconColor: 'hover:text-blue-400', href: '#' },
                { icon: Facebook, color: 'hover:bg-blue-600/20', iconColor: 'hover:text-blue-500', href: '#' },
                { icon: Linkedin, color: 'hover:bg-blue-700/20', iconColor: 'hover:text-blue-600', href: '#' }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
        ...
        <div className="pt-8 text-center">
          <p className="text-gray-500 text-sm">
            © 2025 ResearchHub. The World's First Research Innovation Economy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
