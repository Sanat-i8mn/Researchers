  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-20">
      ...
      <div className="max-w-[1600px] mx-auto p-6">
        <div className="bg-yellow-100 border-2 border-yellow-300 rounded-xl p-4 mb-6 flex items-start gap-3">
        ...
        <div className="grid lg:grid-cols-12 gap-6 h-[calc(100vh-200px)]">
          <div className="lg:col-span-4 bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-md overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              {chatList.map((chat) => (
                <div
                  ...
                  className={`p-4 border-b border-blue-200 cursor-pointer transition-colors ${
                    selectedChat === chat.id ? 'bg-blue-100 border-l-4 border-l-blue-500' : 'hover:bg-blue-50'
                  }`}
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-bold text-gray-900">{chat.participant}</div>
          ...
          <div className="lg:col-span-8 bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-md overflow-hidden flex flex-col">
            <div className="p-6 border-b border-blue-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Researcher RM</div>
                    <div className="text-sm text-gray-500">Statistical Analysis Project</div>
                  </div>
                </div>
                <button className="text-blue-600 font-semibold hover:text-gray-900 transition-colors">
                  View Project
                </button>
              </div>
            </div>
                ...
                <div key={message.id} className={`flex ${message.isMe ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[70%] ${message.isMe ? 'order-2' : 'order-1'}`}>
                    {message.type === 'text' ? (
                      ...
                      <div className="border-2 border-blue-200 rounded-2xl p-4 bg-blue-50 hover:border-blue-400 transition-colors">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
                            <FileText className="text-blue-600" size={24} />
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="font-semibold text-gray-900 truncate">{message.fileName}</div>
                            <div className="text-sm text-gray-500">{message.fileSize}</div>
                          </div>
                          <button className="text-blue-600 hover:text-gray-900 transition-colors">
                            <Download size={20} />
                          </button>
                        </div>
                      </div>
            ...
            <div className="p-4 border-t border-blue-200 bg-blue-50">
              <div className="bg-white rounded-xl border border-blue-200 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-400/20 transition-all">
                <div className="flex items-end gap-2 p-3">
                  ...
                  <textarea
                    ...
                    rows={1}
                    className="flex-1 resize-none focus:outline-none text-gray-900 bg-transparent placeholder-gray-500 max-h-32"
                  />
                  <button
                    onClick={handleSend}
