    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-20">
        ...
        <div className="max-w-[1600px] mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-6 py-3 rounded-xl font-semibold transition-all shadow-lg flex items-center gap-2"
            >
              <Plus size={20} />
              Post New Project
            </button>
      ...
      <div className="max-w-[1600px] mx-auto px-8 py-8">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  activeTab === 'all' ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : 'text-gray-600 hover:bg-blue-50'
                }`}
              >
                All Projects
              </button>
          ...
          <div className="space-y-4">
            {filteredProjects.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button
                  onClick={() => setShowPostProject(true)}
                  className="mt-4 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-6 py-3 rounded-xl font-semibold transition-all"
                >
              ...
              filteredProjects.map((project) => (
                <div key={project._id} className="bg-white/90 backdrop-blur-sm border border-blue-200 rounded-xl p-6 hover:border-blue-400 transition-all shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start gap-3 pb-4 border-b border-blue-200 last:border-0">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-lg p-8">
            ...
            <button className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-6 py-3 rounded-xl font-semibold transition-all">
              Contact Support
            </button>
          </div>
        </div>
