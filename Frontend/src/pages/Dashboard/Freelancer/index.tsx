        ...
        <div className="max-w-[1600px] mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your research projects and proposals</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statsDisplay.map((stat, idx) => (
            <div key={idx} className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-lg p-6 hover:bg-white/90 transition-all">
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              <button
                onClick={() => setActiveTab('active')}
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  activeTab === 'active' ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : 'text-gray-600 hover:bg-blue-50'
                }`}
              >
                Active Projects
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  activeTab === 'proposals' ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : 'text-gray-600 hover:bg-blue-50'
                }`}
              >
                My Proposals
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  activeTab === 'completed' ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : 'text-gray-600 hover:bg-blue-50'
                }`}
              >
                Completed
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  activeTab === 'available' ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : 'text-gray-600 hover:bg-blue-50'
                }`}
              >
                Browse Projects
              </button>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-white/90 border border-blue-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 w-full md:w-64 text-gray-900 placeholder-gray-500"
              />
            </div>
          </div>
            ...
            {activeTab === 'active' && (
              activeProjects.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-gray-600 text-lg">No active projects yet</p>
                  <p className="text-gray-500 text-sm mt-2">Browse available projects and submit proposals to get started</p>
                </div>
              ) : (
            ...
            {activeTab === 'proposals' && (
              proposals.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm mt-2">Start submitting proposals to available projects</p>
                </div>
              ) : (
                proposals.map((proposal) => (
                  <div key={proposal._id} className="bg-white/90 backdrop-blur-sm border border-blue-200 rounded-xl shadow-lg p-6 hover:bg-white hover:border-blue-400 transition-all">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-gray-900 mb-2">{proposal.project.title}</h3>
                        <div className="flex items-center gap-3 mb-3">
            ...
            {activeTab === 'completed' && (
              completedProjects.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm mt-2">Complete projects to build your portfolio</p>
                </div>
              ) : (
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        {project.clientApproved && !project.paymentReleased && (
                          <div className="mt-3 bg-amber-100 border-l-4 border-amber-400 p-3 rounded">
                        ...
                        {project.paymentReleased && (
                          <div className="mt-3 bg-emerald-100 border-l-4 border-emerald-400 p-3 rounded">
            ...
            {activeTab === 'available' && (() => {
              ...
              return filteredProjects.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm mt-2">{searchQuery ? 'Try adjusting your search' : 'Check back later for new opportunities'}</p>
                </div>
              ) : (
