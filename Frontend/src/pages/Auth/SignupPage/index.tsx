...
import { Mail, Lock, User, Eye, EyeOff, Briefcase, GraduationCap, Phone, Plus, X, Award, BookOpen, Briefcase as BriefcaseIcon } from 'lucide-react';
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="font-bold text-[#1F1F1F] mb-1">Request a Service</div>
              ...
              >
                ...
                <div className="font-bold text-[#1F1F1F] mb-1">Join as Expert</div>
