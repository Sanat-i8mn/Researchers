    ...
    <section className="relative py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative h-auto min-h-[300px] sm:h-80 overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="relative group w-full">
                  ...
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl px-6 sm:px-10 lg:px-16 py-8 sm:py-12 border border-blue-100 shadow-2xl overflow-visible">
                    {/* Quote Icon - Fixed positioning */}
                    <motion.div
                      className="absolute -top-6 -left-6 sm:-top-8 sm:-left-8 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full flex items-center justify-center shadow-lg z-10"
